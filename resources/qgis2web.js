...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [1780810.000000, 5111630.000000, 1905820.000000, 5242220.000000], maxZoom: 14, minZoom: 2, projection: new ol.proj.Projection({
            code: 'EPSG:3946',
...
var onSingleClick = function(evt) {
    ...
    map.on('pointermove', function(evt) {
        ...
        if (measuring) {
            /** @type {string} */
            var helpMsg = 'Cliquez pour commencer la mesure';
            if (sketch) {
 ...
 * @type {string}
 */
var continueLineMsg = 'Cliquez pour continuer, double-clic pour arrêter';
